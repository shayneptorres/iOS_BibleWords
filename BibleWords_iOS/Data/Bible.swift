...
extension Bible {
    enum Book: Int, CaseIterable {
        ...
        var shortTitle: String {
            ...
            case .thessalonians1: return "1 Thes"
            case .thessalonians2: return "2 Thes"
            case .timothy1: return "1 Tm"
            case .timothy2: return "2 Tm"
            case .titus: return "Ts"
